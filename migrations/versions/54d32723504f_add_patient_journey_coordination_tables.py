"""add patient journey coordination tables

Revision ID: 54d32723504f
Revises: h8i9j0k1l2m3
Create Date: 2025-11-09 21:52:40.648193
...
def upgrade():
    ...
    if 'patient_journeys' not in existing_tables:
        ...
        op.create_index(op.f('ix_patient_journeys_created_at'), 'patient_journeys', ['created_at'], unique=False)
    ...
    if 'journey_steps' not in existing_tables:
...
def downgrade():
    ...
    op.drop_table('patient_journeys')
